...
contract TVPunks is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public uriPrefix = "https://gateway.pinata.cloud/ipfs/QmSSHQvkA1pvvKDwXJB1TFfB7e6ZfJARJCyK2uVcHvL3UK/";
    ...
    bool public TogglePresale = false;
    ...
    constructor(uint256 _cost, uint256 _maxSupply, uint256 _presaleCost)
        ERC721A("TV Punks", "TVP")
    {
        setCost(_cost);
    ...
    function presale(bytes32[] calldata merkleProof)
        ...
        nonReentrant
    {
        require(!TogglePresale, "Presale is ended");
